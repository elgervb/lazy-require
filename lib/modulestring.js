module.exports = (function modulestring() {
  ...
  var loadModuleStringFromPackageJson = function(basePath, module) {
    ...
    dependencies = mergeDependencies(dependencies, packageJson.lazyDependencies);
    
    // try to find the version info from all dependencies (regardless of dev)
    ...
    log.verbose('Loading ' + module + ' module which is not mentioned in package.json of module ' + packageJson.name);
    return module;
  }
